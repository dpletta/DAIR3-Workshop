"""
agentGoogleGUI.py
Single-agent chat GUI seeded with Google Gemini. Uses the shared
...
CLI:
    python agentGoogleGUI.py                  # default role: general.md
    python agentGoogleGUI.py researcher.md
    python agentGoogleGUI.py grant_writer_NIH.md
...
if __name__ == "__main__":
    ...
    launch(preferred_provider="gemini", window_title="JuanGemini", role_md=args.role_md)
